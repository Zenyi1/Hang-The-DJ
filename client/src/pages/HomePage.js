...
const HomePage = () => {
  return (
    <div
      ...
      style={{ backgroundImage: "url('/cool-background.png')" }} // Use this path
    >
      <h1 className="text-7xl md:text-8xl font-extrabold text-white drop-shadow-lg mb-10 animate-pulse">
        Hang The DJ
      </h1>
      <div className="flex flex-col gap-4">
        <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300 transform hover:scale-105">
          I'm a DJ
        </button>
